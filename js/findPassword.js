...
input[3].onfocus = function () {
    input[3].placeholder = '请输入6-12位字符的密码';
}
input[3].onblur = function () {
    input[3].placeholder = '请输入确认密码';
}
btn.onclick = function () {
    var reg = /^(0|86|17951)?(13[0-9]|15[012356789]|166|17[3678]|18[0-9]|14[57])[0-9]{8}$/;
    var reg1 = /^\w{6,12}$/;
    if (reg.test(input[0].value) && input[1].value == num && reg1.test(input[2].value) && input[2].value == input[3].value) {
